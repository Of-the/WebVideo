                ...
                <div class="proflle_tab_body">
                    <div class="proflle_tab_workplace clearfix">
                        ...
                        <div class="profile_ifo_area">
                            <form action="commitupdate.do">
                             <input id="userEmail" name="userEmail" placeholder="${user.userEmail}" type="hidden">
                                <div class="form_group">
                                    <span class="dd">旧　密　码：</span>
                                    <input id="userPassword" name="userPassword" placeholder="${user.userPassword}" type="password">
                                    <span id="oldMsg"></span>
                                </div>
                                <div class="form_group">
                                    <span class="dd">新　密　码：</span>
                                    <input id="regPsw" name="password" type="password">
                                </div>
                                <div class="form_group">
                                    <span class="dd">确认新密码：</span>
                                    <input id="regPswAgain" name="psw_again" type="password">
                                   <span id="passMsg"></span>
                                </div>
                                <div class="form_submit dd">
                                    <input onclick="commitRegForm();" value="保　存" type="submit"  >
                                    <a href="mima.do">取消</a>
                                </div>
                            </form>
                        </div>
