...
<nav class="navbar-inverse">
	...
	<div class="container" style="margin-top: 20px;">
		...
		<form id="infoForm" class="form-horizontal" action="insertCourse.do" method="post" novalidate="novalidate">			
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<textarea class="form-control" id="courseDesc" placeholder="${course.courseDesc}" value="" name="courseDesc" rows="3"></textarea>
				</div>
			</div>
			<div class="form-group">
...
<div id="modal-body" class="modal-body"> Modal Message </div><div id="modal-footer" class="modal-footer"></div></div></div></div>
<div id="modal-background" class=""></div>
</body>
</html>