...
<nav class="navbar-inverse">
	...
	<div class="container" style="margin-top: 20px;">
		...
		<form id="infoForm" class="form-horizontal" action="insertSpeaker.do" novalidate="novalidate">

			<div class="form-group">
				<label for="speakerName" class="col-sm-2 control-label">讲师编号</label>
				<div class="col-sm-10">
					<input class="form-control" name="speakerId" id="speakerId" placeholder="讲师编号" type="text">
				</div>
			</div>
			<div class="form-group">
				<label for="speakerName" class="col-sm-2 control-label">讲师姓名</label>
				<div class="col-sm-10">
					<input class="form-control" name="speakerName" id="speakerName" placeholder="讲师姓名" type="text">
				</div>
			</div>
			<div class="form-group">
				<label for="speakerJob" class="col-sm-2 control-label">职位</label>
				<div class="col-sm-10">
					<input class="form-control" name="speakerJob" id="speakerJob" placeholder="职位" type="text">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" name="speakerHeadUrl" id="speakerHeadUrl" placeholder="头像地址"  type="text">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" name="speakerDesc" id="speakerDesc" placeholder="简介" type="text">
				</div>
			</div>
			<div class="form-group">
